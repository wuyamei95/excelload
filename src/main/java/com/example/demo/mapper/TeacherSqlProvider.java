...
import com.example.demo.bean.TeacherExample.Criteria;
import com.example.demo.bean.TeacherExample.Criterion;
...
public class TeacherSqlProvider {
    ...
    protected void applyWhere(TeacherExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
